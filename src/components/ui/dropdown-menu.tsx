...
function DropdownMenuCheckboxItem({
	...
	return (
		<DropdownMenuPrimitive.CheckboxItem
			...
			checked={checked}
			{...props}>
			<span className="pointer-events-none absolute left-2 flex size-4 items-center justify-center rounded-[4px] border border-slate-300 bg-white transition-colors group-data-[state=checked]:border-primary group-data-[state=checked]:bg-primary">
