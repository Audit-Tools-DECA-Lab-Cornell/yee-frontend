...
export const yeeDomainThemes: Record<YeeDomainKey, DomainTheme> = {
	access: {
		...
		active:
			"border-emerald-400 bg-gradient-to-br from-[#f5fbf6] via-[#edf7ef] to-[#dcefe0] text-emerald-950 ring-2 ring-emerald-200 shadow-[0_16px_32px_-24px_rgba(72,117,83,0.34)]",
	...
	activitySpaces: {
		...
		active:
			"border-blue-400 bg-gradient-to-br from-[#f7f9ff] via-[#eef3ff] to-[#dfe8ff] text-blue-950 ring-2 ring-blue-200 shadow-[0_16px_32px_-24px_rgba(80,104,180,0.34)]",
	...
	amenities: {
		...
		active:
			"border-amber-400 bg-gradient-to-br from-amber-50 via-amber-100 to-amber-200 text-amber-950 ring-2 ring-amber-200 shadow-[0_16px_32px_-24px_rgba(180,83,9,0.32)]",
	...
	experienceOfSpace: {
		...
		active:
			"border-teal-400 bg-gradient-to-br from-teal-50 via-teal-100 to-teal-200 text-teal-950 ring-2 ring-teal-200 shadow-[0_16px_32px_-24px_rgba(17,94,89,0.34)]",
	...
	aestheticsAndCare: {
		...
		active:
			"border-rose-400 bg-gradient-to-br from-rose-50 via-rose-100 to-rose-200 text-rose-950 ring-2 ring-rose-200 shadow-[0_16px_32px_-24px_rgba(159,18,57,0.32)]",
	...
	useAndUsability: {
		...
		active:
			"border-violet-400 bg-gradient-to-br from-violet-50 via-violet-100 to-violet-200 text-violet-950 ring-2 ring-violet-200 shadow-[0_16px_32px_-24px_rgba(91,33,182,0.34)]",
