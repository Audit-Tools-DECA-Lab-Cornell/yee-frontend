		...
		<AuthShell>
			<div className="space-y-6">
				...
				<div className="space-y-1.5">
					<h2 className="text-2xl font-semibold tracking-tight text-foreground">Waiting for approval</h2>
					<p className="text-sm text-muted-foreground leading-relaxed">
						Your account is awaiting approval from a manager. You&apos;ll be notified by email when access
						is granted, and you can also check the status below.
					</p>
				</div>
